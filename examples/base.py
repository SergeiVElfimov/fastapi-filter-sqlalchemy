...
from fastapi_filter_sqlalchemy import Filter, FilterDepends, with_prefix
...
async def get_users(
    ...
    query = user_filter.filter(query)  # type: ignore
...
async def get_addresses(
    ...
    query = address_filter.filter(query)  # type: ignore
